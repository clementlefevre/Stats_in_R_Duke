...
It seems that the following features,the logarithmic transformation  did imporove :
...
```{r}
bad_balances_features<- high_skewed_features[! high_skewed_features %in% c("Lot.Area","area","X1st.Flr.SF","TotRms.AbvGrd")]
bad_balances_features
```
...
We could plot a correlogramm of all variables :

...
The data were gathered via face-to-face interviews by US households, for an average 90 minutes.
...
As a french, two factors in the US society seem very specifics to me : racial discrimation and attitude towards guns.
...
Out of the current scope, i'd like to see the incomes level relationship with gun ownership :
...
We can clearly observe that during a 40 years time period, the gun ownership is still related to the income level. Rich households are more prone to won a gun, but in 2012, gun owners are less wealthy.
...
We are in the case of two categorical variables, with at least 1 with more than 2 levels
...
What we obesrve here is a decreasing trend towards zero for the value.
I would conclude that over the year, the chance of rejection of the hypothese of independance between gun ownership and race has got weaker.

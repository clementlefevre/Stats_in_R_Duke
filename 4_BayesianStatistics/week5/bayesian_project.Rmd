...
With fitted value of 75.9754% for BMA and 74.4379% for HPM, we are 5% less than the observed value.
...
I found worring the heterogenous spread of residuals for fitted audience_score, which implies the dataset might be first purged from low-rated movies, and that i did an error during the data preparation.
